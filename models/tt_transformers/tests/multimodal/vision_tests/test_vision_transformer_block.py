"""Gemma3 Test for Vision Transformer block"""
...
from models.tt_transformers.tt.multimodal.gemma3.gemma_image_block import TtGemmaImageTransformerBlock
...
def test_block_inference(batch, num_chunks, mesh_device, reset_seeds, gated, device_params):
    dtype = ttnn.bfloat16
    pcc_required = 0.99
    gated = False
