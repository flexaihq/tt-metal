...
def test_demo_text(
    ...
    if model_name in supported_models:
        ...
        dict_target_decode_tok_s_u = {
            ...
            #
            "N150_Qwen2.5-VL-7B": 20,  # TODO Update target
            "N300_Qwen2.5-VL-7B": 30,  # TODO Update target
        }
    ...
    if is_ci_env:
        ...
        if global_batch_size == 32:
            ...
            ci_target_decode_tok_s_u = {
                ...
                # N300 targets
                "N300_Qwen2.5-7B": 20,
                "N300_Qwen2.5-VL-7B": 20,  # TODO Update target
                # T3K targets
