# SPDX-FileCopyrightText: © 2023 Tenstorrent Inc.Add commentMore actions
...
# from models.experimental.gemma3_1b.tt.model_config import Gemma3TextTtModelArgs # Importing Model Args for TextModel
...
@pytest.mark.parametrize(
    "optimizations",
    [
        # lambda model_args: DecodersPrecision.performance(model_args.n_layers, model_args.model_name), #essay
...
def test_model_inference(
    ...
    pcc = 0.90 if mode_accuracy else 0.86
