...
def test_mlp_inference(seq_len, batch_size, use_program_cache, reset_seeds, device):
    ...
    first_layer_prefix = "language_model.layers.0.feed_forward"
    # print(first_layer_prefix)
    partial_state_dict = {
