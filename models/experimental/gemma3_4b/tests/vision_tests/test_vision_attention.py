...
def test_attention_inference(batch, num_chunks, mesh_device, use_program_cache, reset_seeds):
    dtype = ttnn.bfloat16
    pcc_required = 0.99
    ...
    first_layer_prefix = "vision_tower.vision_model.encoder.layers.0.attn."
    # partial_state_dict = {
