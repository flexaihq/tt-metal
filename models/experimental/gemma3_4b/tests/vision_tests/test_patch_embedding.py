...
def test_conv2d_inference(
    ...
    tt_layer_prefix = f"{model_args.state_dict_vision_prefix}.embeddings.patch_embedding."
    first_layer_prefix = f"{model_args.state_dict_vision_prefix}.embeddings.patch_embedding._linear."
    partial_state_dict = {
