...
def test_layernorm_inference(mesh_device, use_program_cache, reset_seeds, layer_name):
    dtype = ttnn.bfloat16
    ...
    if layer_name == "layer_norm1":
        first_layer_prefix = "vision_tower.vision_model.encoder.layers.0.ln_1."
    else:
        first_layer_prefix = "vision_tower.vision_model.encoder.layers.0.ln_2."
