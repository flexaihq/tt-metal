...
def test_block_inference(batch, num_chunks, mesh_device, use_program_cache, reset_seeds, gated):
    dtype = ttnn.bfloat16
    pcc_required = 0.99
    gated = False
    ...
    if gated:
        first_layer_prefix = "vision_tower.vision_model.encoder.layers.0."
    else:
        first_layer_prefix = "vision_tower.vision_model.encoder.layers.0."
    # partial_state_dict = {
