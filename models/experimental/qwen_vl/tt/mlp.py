...
class QwenTTVisionMLP(LightweightModule):
    def __init__(
        ...
        self.b1 = as_tensor("gate_proj", ttnn.bfloat16, is_bias=True)

        self.w3 = as_tensor("up_proj", dtype)
        self.b3 = as_tensor("up_proj", ttnn.bfloat16, is_bias=True)
    ...
    def forward(self, x: ttnn.Tensor) -> ttnn.Tensor:
        ...
        # w3_out = ttnn.linear(
        #     x, self.w3, bias=self.b3, dtype=ttnn.bfloat16, memory_config=ttnn.DRAM_MEMORY_CONFIG,
        #     compute_kernel_config=compute_kernel_config
        # )
